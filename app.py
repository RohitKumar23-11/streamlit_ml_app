...
def main():
    ...
    if choice == "Home":
        ...
        image1 = Image.open(r"https://github.com/RohitKumar23-11/streamlit_ml_app/blob/main/1080.jpg")
        ...
        image = Image.open(r"https://github.com/RohitKumar23-11/streamlit_ml_app/blob/main/thank-you.jpg")
